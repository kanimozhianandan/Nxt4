...
def view_friends(request, username, template_name='friendship/friends.html'):
...
@login_required
def friendship_add_friend(request, to_username, template_name='friendship/addfriend.html'):
...
@login_required
def friendship_request_list(request, template_name='friendship/requestlist.html'):
...
@login_required
def friendship_request_list_rejected(request, template_name='friendship/requestlist.html'):
...
@login_required
def friendship_requests_detail(request, friendship_request_id, template_name='friendship/request.html'):
...
@login_required
def follower_add(request, followee_username, template_name='friendship/follow.html'):
    """ Create a following relationship """
    ctx = {'followee_username': followee_username}

    if request.method == 'POST':
        followee = user_model.objects.get(email=followee_username)
...
def all_users(request, template_name="friendship/base.html"):
